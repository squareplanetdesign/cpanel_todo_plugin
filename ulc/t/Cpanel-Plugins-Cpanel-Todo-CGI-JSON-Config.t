...
use_ok('Cpanel::Plugins::Cpanel::Todo::CGI::JSON::Config', 'Module loads ok');
...
subtest "When attempting to run the cgi as non-root, user should get an unauthorized error." => sub {
    ...
    my $cgi = Cpanel::Plugins::Cpanel::Todo::CGI::JSON::Config->new();
    my $got = $cgi->run();
...
subtest "When loading the configuration fails, user should get a server error." => sub {
    ...
    my $mock = Test::MockModule->new('Cpanel::Plugins::Cpanel::Todo::Config');
...
subtest "When a user requests to change the configuration, it works." => sub {
    ...
    $cgi = Cpanel::Plugins::Cpanel::Todo::CGI::JSON::Config->new($stdin);
    $got = $cgi->run();
